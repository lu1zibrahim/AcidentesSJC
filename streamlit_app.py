...
st.markdown("- Pois tanto para os acidêntes com e sem vítimas, nem os acidentes com vítimas de diferentes gravidades, mostraram dados para sugerir o contrário.")
st.markdown("- Assim com os dados que possuimos no momento, vemos que as condições não afetam o número de acidentes, nem a gravidade do acidente.")
